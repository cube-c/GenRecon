...
class PbrVaeTrainer(BasicTrainer):
    ...
    def training_losses(
        self, x: sp.SparseTensor, mesh: List[MeshWithPbrMaterial] = None, **kwargs
    ) -> Tuple[Dict, Dict]:
        """
    ...
    def run_snapshot(
        ...
        sample_dict = {
            ...
            "gt_mra": {
                "value": torch.cat([gt_renders["metallic"], gt_renders["roughness"], gt_renders["alpha"]], dim=1) * 2
                - 1,
                "type": "image",
            },
            "pred_mra": {
                "value": torch.cat([pred_renders["metallic"], pred_renders["roughness"], pred_renders["alpha"]], dim=1)
                * 2
                - 1,
                "type": "image",
            },
