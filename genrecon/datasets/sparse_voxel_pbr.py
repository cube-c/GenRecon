    ...
    def read_mesh_with_texture(self, root, instance):
        ...
        for mat in dump["materials"]:
            materials.append(
                PbrMaterial(
                    base_color_texture=(
                        self._texture_from_dump(mat["baseColorTexture"])
                    ...
                    roughness_texture=(
                        self._texture_from_dump(mat["roughnessTexture"])
                        if mat["roughnessTexture"] is not None
                        else None
                    ),
                    roughness_factor=mat["roughnessFactor"],
                    alpha_texture=(
                        self._texture_from_dump(mat["alphaTexture"]) if mat["alphaTexture"] is not None else None
                    ),
